...
.post(cors.corsWithOptions, authenticate.verifyUser,authenticate.verifyOrdinaryUser, (req, res, next) => {
    Dishes.findById(req.params.dishId)
    .then((dish) => {
        if (dish != null) {
            req.body.author = req.user._id;
...
.put(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyOrdinaryUser, (req, res, next) => {
...
.delete(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyOrdinaryUser, (req, res, next) => {
    Dishes.findById(req.params.dishId)
    .then((dish) => {
        if ((dish != null && dish.comments.id(req.params.commentId) != null) && (req.user._id==dish.comments.id(req.params.commentId).author._id)) {
